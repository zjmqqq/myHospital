# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2020-02-26 03:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('a_8_00', models.BooleanField(default=True)),
                ('a_8_30', models.BooleanField(default=True)),
                ('a_9_00', models.BooleanField(default=True)),
                ('a_9_30', models.BooleanField(default=True)),
                ('a_10_00', models.BooleanField(default=True)),
                ('a_10_30', models.BooleanField(default=True)),
                ('a_11_00', models.BooleanField(default=True)),
                ('a_11_30', models.BooleanField(default=True)),
            ],
        ),
        migrations.CreateModel(
            name='contreteTime_p',
            fields=[
                ('ctId', models.AutoField(primary_key=True, serialize=False)),
                ('p_13_30', models.BooleanField(default=True)),
                ('p_14_00', models.BooleanField(default=True)),
                ('p_14_30', models.BooleanField(default=True)),
                ('p_15_00', models.BooleanField(default=True)),
                ('p_15_30', models.BooleanField(default=True)),
                ('p_16_00', models.BooleanField(default=True)),
                ('p_16_30', models.BooleanField(default=True)),
            ],
        ),
        migrations.CreateModel(
            name='department',
        ...
        migrations.AddField(
            ...
            name='scheduling_p',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='patient.scheduling'),
        ),
        migrations.AddField(
